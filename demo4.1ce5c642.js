...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"projects/src/js/cursor.js":[function(require,module,exports) {
"use strict";
...
},{"gsap":"../node_modules/gsap/index.js","./utils":"projects/src/js/utils.js"}],"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{}],"projects/src/js/demo4/index.js":[function(require,module,exports) {
"use strict";
...
const rotationsArr = Array.from({
  length: elems.length
}, () => (0, _utils.randomNumber)(-30, 30));
const translationArr = Array.from({
  length: elems.length
}, () => (0, _utils.randomNumber)(-100, 100));
lscroll.on('scroll', obj => {
  for (const key of Object.keys(obj.currentElements)) {
    ...
    if (obj.currentElements[key].el.classList.contains('gallery__item')) {
      ...
      const rotationVal = progress > 0.6 ? (0, _utils.clamp)((0, _utils.map)(progress, 0.6, 1, 0, rotationsArr[idx]), Math.min(0, rotationsArr[idx]), Math.max(0, rotationsArr[idx])) : 0;
      const translationVal = progress > 0.6 ? (0, _utils.clamp)((0, _utils.map)(progress, 0.6, 1, 0, translationArr[idx]), Math.min(0, translationArr[idx]), Math.max(0, translationArr[idx])) : 0;
...
Promise.all([(0, _utils.preloadImages)('.gallery__item-imginner'), (0, _utils.preloadFonts)('vxy2fer')]).then(() => {
...
},{"../utils":"projects/src/js/utils.js","../cursor":"projects/src/js/cursor.js","locomotive-scroll":"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7364" + '/');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","projects/src/js/demo4/index.js"], null)
//# sourceMappingURL=/demo4.1ce5c642.js.map