...
},{}],"projects/src/js/demo5/index.js":[function(require,module,exports) {
"use strict";
...
lscroll.on('scroll', obj => {
  for (const key of Object.keys(obj.currentElements)) {
    if (obj.currentElements[key].el.classList.contains('gallery__item-imginner')) {
      ...
      const saturateVal = progress < 0.5 ? (0, _utils.clamp)((0, _utils.map)(progress, 0, 0.5, 0, 1), 0, 1) : (0, _utils.clamp)((0, _utils.map)(progress, 0.5, 1, 1, 0), 0, 1);
      const brightnessVal = progress < 0.5 ? (0, _utils.clamp)((0, _utils.map)(progress, 0, 0.5, 0, 1), 0, 1) : (0, _utils.clamp)((0, _utils.map)(progress, 0.5, 1, 1, 0), 0, 1);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3456" + '/');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","projects/src/js/demo5/index.js"], null)
//# sourceMappingURL=/demo5.9a606f14.js.map